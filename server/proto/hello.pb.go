...
var file_proto_hello_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x35, 0x0a, 0x08, 0x47, 0x65, 0x74,
...
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: hello.HelloService.GetHello:input_type -> hello.HelloRequest
	1, // 1: hello.HelloService.GetHello:output_type -> hello.HelloResponse
